                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    <select class="form-control">
                                        <option value="" selected disabled> Pricing Range (ZAR) </option>
                                        @foreach ($pricings as $key => $pricing)
                                            @if (count($lcars) == 6)
                                                <a href="{{ route('front.cars') }}" class="mybtn1">
                                                    {{ $langg->lang15 }}
                                                </a>
                                            @elseif ($pricing->minimum == 15000000)
                                                <option value="{{ $pricing->id }}">{{ $pricing->minimum }} - ~
                                                </option>
                                            @endif
                                            <option value="{{ $pricing->id }}">{{ $pricing->minimum }} -
                                                {{ $pricing->maximum }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <ul class="select-list">
                                ...
                                <li>
                                    <button type="submit" class="mybtn1"
                                        style="width: 100%; outline: 0;">{{ $langg->lang12 }}</button>
                                </li>
                            </ul> --}}
                        </form>
                    </div>
